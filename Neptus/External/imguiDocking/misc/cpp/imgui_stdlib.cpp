...
bool ImGui::InputTextEx(const char* label, const char* hint, std::string* str,
    ...
    return InputTextEx(label, hint, (char*)str->c_str(), str->capacity() + 1, size_arg, flags, InputTextCallback, &cb_user_data);
}
